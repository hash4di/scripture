...
class VersesControllerTest < ActionController::TestCase
  ...
  test "should create verse" do
    assert_difference('Verse.count') do
      post :create, verse: { color: @verse.color, description: @verse.description, label: @verse.label, title: @verse.title }
    end
  ...
  test "should update verse" do
    patch :update, id: @verse, verse: { color: @verse.color, description: @verse.description, label: @verse.label, title: @verse.title }
    assert_redirected_to verse_path(assigns(:verse))
  end
